...
> **Primary Technology Stack:** Gemini 2.5 Flash (Voice STT), Gemini 2.5 Flash (LLM Reasoning), Smallest AI (TTS Engine), `BAAI/bge-small-en-v1.5` (FastEmbed), ChromaDB, OpenStreetMap MCP, n8n Workflow Engine.
...
- **LLM Reasoning Engine:** **Gemini 2.5 Flash** (High-speed, high-accuracy reasoning & multi-turn grounded response generation).
